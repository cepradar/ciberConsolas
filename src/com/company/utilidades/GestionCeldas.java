...
public class GestionCeldas extends DefaultTableCellRenderer{
    ...
    private ImageIcon iconoGuardar = new ImageIcon(getClass().getResource("/com/company/recursos/iconos/ico_guardar.png"));
    private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource("/com/company/recursos/iconos/ico_buscar.png"));
    private ImageIcon iconoEmpezar = new ImageIcon(getClass().getResource("/com/company/recursos/iconos/ico_empezar.png"));
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        if( tipo.equals("icono"))
        {
            ...
            }else if( String.valueOf(value).equals("EMPEZAR"))
            {
                label.setIcon(iconoEmpezar);
            }
